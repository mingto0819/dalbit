...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-balgan-red text-balgan-cream">
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 h-16 md:h-[72px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-5">
          ...
          <button aria-label="Cart" className="relative hover:opacity-80 transition-opacity">
            ...
            <span className="absolute -top-1.5 -right-2 bg-balgan-cream text-balgan-red text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">
              0
            </span>
          </button>
        </div>
